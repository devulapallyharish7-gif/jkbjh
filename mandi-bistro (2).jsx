...
// Emoji + gradient tile for each menu item — no external image requests needed
const menuTiles = [
  { keys: ["alfaham"], emoji: "🍗", bg: ["#7B2D00","#C84B00"] },
  { keys: ["wings"], emoji: "🍗", bg: ["#7B2D00","#C84B00"] },
  { keys: ["broasted"], emoji: "🍗", bg: ["#6B3A00","#B85C00"] },
  { keys: ["fry mandi","fry"], emoji: "🍗", bg: ["#5C2D00","#A04000"] },
  { keys: ["juicy"], emoji: "🍲", bg: ["#4A1500","#8B3A00"] },
  { keys: ["shawarma"], emoji: "🌯", bg: ["#3D2000","#7A4500"] },
  { keys: ["dum ka mutton","dum ka"], emoji: "🥘", bg: ["#3B1A00","#723200"] },
  { keys: ["mutton"], emoji: "🥩", bg: ["#4A1500","#8B3A00"] },
  { keys: ["fish + prawns","fish+prawns"], emoji: "🦐", bg: ["#003D4A","#006B7A"] },
  { keys: ["prawns"], emoji: "🦐", bg: ["#003D30","#006B55"] },
  { keys: ["fish"], emoji: "🐟", bg: ["#003A4A","#006A7A"] },
  { keys: ["paneer masala"], emoji: "🧀", bg: ["#7A4500","#C47A00"] },
  { keys: ["paneer"], emoji: "🧀", bg: ["#6B4500","#B07000"] },
  { keys: ["mushroom kaju","mushroom"], emoji: "🍄", bg: ["#3D3000","#7A6200"] },
  { keys: ["french fries","fries"], emoji: "🍟", bg: ["#7A5500","#C49000"] },
  { keys: ["chilli chicken"], emoji: "🌶️", bg: ["#7A0000","#C41A00"] },
  { keys: ["chilli paneer"], emoji: "🌶️", bg: ["#7A2000","#C44000"] },
  { keys: ["chilli prawns"], emoji: "🌶️", bg: ["#7A1000","#C43000"] },
  { keys: ["chilli fish"], emoji: "🌶️", bg: ["#7A0800","#C42000"] },
  { keys: ["crispy corn","corn"], emoji: "🌽", bg: ["#7A5A00","#C49500"] },
  { keys: ["lollipop"], emoji: "🍗", bg: ["#6B2500","#B04500"] },
  { keys: ["drumstick"], emoji: "🍗", bg: ["#6B2500","#B04500"] },
  { keys: ["majestic"], emoji: "🍗", bg: ["#5C2000","#A03800"] },
  { keys: ["crispy chicken"], emoji: "🍗", bg: ["#5C2200","#A03C00"] },
  { keys: ["crispy fish"], emoji: "🐟", bg: ["#003240","#005C6B"] },
  { keys: ["crispy prawns"], emoji: "🦐", bg: ["#002D40","#00546B"] },
  { keys: ["crispy mushroom","creamy mushroom"], emoji: "🍄", bg: ["#3A2D00","#705800"] },
  { keys: ["kunafa"], emoji: "🍮", bg: ["#7A4A00","#C07A00"] },
  { keys: ["apricot"], emoji: "🍑", bg: ["#7A3A00","#C06000"] },
  { keys: ["sweet pan"], emoji: "🍬", bg: ["#6B0050","#B00080"] },
  { keys: ["soft drink","can"], emoji: "🥤", bg: ["#003A7A","#0060C4"] },
  { keys: ["water bottle","water"], emoji: "💧", bg: ["#003060","#0055A0"] },
  { keys: ["soup"], emoji: "🥣", bg: ["#4A1800","#8B3500"] },
  { keys: ["extra rice","rice"], emoji: "🍚", bg: ["#4A3800","#7A6200"] },
  { keys: ["curd"], emoji: "🥛", bg: ["#404040","#707070"] },
  { keys: ["chicken piece","chicken"], emoji: "🍗", bg: ["#6B2800","#B04800"] },
  { keys: ["mutton piece"], emoji: "🥩", bg: ["#4A1500","#8B3A00"] },
  { keys: ["combo"], emoji: "🍽️", bg: ["#3A2000","#7A4A00"] },
];

function getMenuTile(itemName) {
  const lower = itemName.toLowerCase();
  for (const tile of menuTiles) {
    if (tile.keys.some(k => lower.includes(k))) return tile;
  }
  return { emoji: "🍽️", bg: ["#3E2723","#7B4B3A"] };
}

function MenuItemImage({ name }) {
  const tile = getMenuTile(name);
  return (
    <div style={{
      flexShrink: 0, width: 86, height: 80,
      background: `linear-gradient(135deg, ${tile.bg[0]}, ${tile.bg[1]})`,
